...
//    cout << m << endl;
    ...
    cout << "####################################################"<<endl;
    Game g5(10,10);
    std::shared_ptr<Character> sniperP = Game::makeCharacter(SNIPER,PYTHON,3,4,4,3);
    ...
    std::shared_ptr<Character> soldierP = Game::makeCharacter(SOLDIER,PYTHON,6,4,4,3);
...
//    g5.attack(GridPoint(5,5),GridPoint(5,3));
//    g5.attack(GridPoint(5,5),GridPoint(5,3));
//    g5.reload(GridPoint(5,5));
//    g5.attack(GridPoint(5,5),GridPoint(3,7));
    cout << g5 << endl;
    g5.attack(GridPoint(2,3),GridPoint(5,3));
    g5.attack(GridPoint(2,3),GridPoint(5,3));
//    g6.attack(GridPoint(2,3),GridPoint(0,3));
    cout << g6 << endl;
    g5.attack(GridPoint(2,3),GridPoint(5,3));
//    g5.attack(GridPoint(2,3),GridPoint(5,3));
